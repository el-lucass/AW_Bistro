...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2026 a las 11:32:17
...
CREATE TABLE `incidencias` (
  ...
  `causas` set('retraso','falta producto','mal estado','') NOT NULL,
...
INSERT INTO `incidencias` (`id_usuario`, `id_pedido`, `causas`, `descripcion`, `imagen`, `estado`) VALUES
(3, 2, 'falta producto', 'pp', 'default.png', 'resuelta');
...
(2, 3, 5, 2, '2026-03-22 18:56:47', 'entregado', 'llevar', 0.00, 0.00, 18.29),
...
(4, 'camarero', 'a@a', 'a', '', '$2y$10$3ddpxCtdM.C4tPpa3qMo3u5SKe5XtYTrf5fgzZJ9KwsOmJ6dfehw6', 'camarero', 'default.png', 0),
(5, 'cocinero', 'a@a', 'a', '', '$2y$10$3ddpxCtdM.C4tPpa3qMo3u5SKe5XtYTrf5fgzZJ9KwsOmJ6dfehw6', 'cocinero', 'default.png', 0),
(6, 'b', 'a@a', 'a', '', '$2y$10$3ddpxCtdM.C4tPpa3qMo3u5SKe5XtYTrf5fgzZJ9KwsOmJ6dfehw6', 'cliente', 'default.png', 0);
