...
$user_id = $_SESSION['id'];
$saldoBistrocoins = Usuario::getBistrocoins($user_id);
...
<h1 class='mt-0 mb-10'>Historial de Pedidos</h1>
<p class='texto-gris mb-30'>Tienes <strong>{$saldoBistrocoins} BistroCoins</strong> acumulados.</p>";
