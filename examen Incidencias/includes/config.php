...
define('BD_NAME', 'examen3');
define('BD_USER', 'examen3'); // Recuerda usar 'root' si te daba Access Denied
define('BD_PASS', 'examen3pass'); // Vacío '' si usas 'root' en XAMPP

// Configuración de Rutas
define('RAIZ_APP', __DIR__);
define('RUTA_APP', '/Proyectos/AW_Bistro/examen Incidencias');
