...
define('BD_NAME', 'examen2');
define('BD_USER', 'examen2'); // Recuerda usar 'root' si te daba Access Denied
define('BD_PASS', 'examen2pass'); // Vacío '' si usas 'root' en XAMPP

// Configuración de Rutas
define('RAIZ_APP', __DIR__);
define('RUTA_APP', '/Proyectos/AW_Bistro/examen Valoraciones Productos y Productos favoritos');
